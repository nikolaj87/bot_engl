...
public class CurrencyService {
    ...
    public static String getCurrencyRate(String message, CurrencyModel model) throws IOException, ParseException {
        URL url = new URL("https://www.privatbank.by/api/exrates/rates" + message + "?parammode=2");
        ...
        return "Official rate of HRN to " + model.getCur_Abbreviation() + "\n" +
                "on the date: " + getFormatDate(model) + "\n" +
                "is: " + model.getCur_OfficialRate() + " PB per " + model.getCur_Scale() +
