...
public class MessageGenerator {
    ...
    private final String commandsMessage =
            "+иностранный язык +родной язык  " +
                    ...
                    "\nрегистр не важен" +
                    "\n\nswsw - посмотреть последние 30 слов студента и его домашку" +
    ...
    private final String ukr =
            """
                    ...
                    - меню ALL WORDS
                        це всi вашi слова за весь час. Якщо ви гарно вивчили слово, то його можно вiдправити до архiву i це слово бiльше не буде з`являтися в списку всiх слiв.
                                        
                    - меню ARCHIVE
                        це список слiв, вiдправленних в архiв. Слово можна вiдновити з архiву та вiдправити до списку слiв.
